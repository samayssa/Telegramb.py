...
async def next_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if parsed_identifier is None or parsed_price is None:
        help_text = ("Usage examples for /next:\n\n"
                     "1) By username:\n/next @samayofficial 10\nExample: opens auction for the user with username @samayofficial with base price 10 CR.\n\n"
                     "2) With extra display name before username:\n/next Virat @samayofficial 10\nExample: will show name as 'Virat' and username as @samayofficial.\n\n"
                     "3) By Telegram ID:\n/next 123456789 10\nExample: will lookup user by Telegram ID and open auction with base price 10 CR.\n")
